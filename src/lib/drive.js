...
async function archiveUserConversations(userId) {
  ...
  for (const conversation of conversations) {
    ...
    // destroy everything already archived in this file (and, since
    // readArchivedMessages serves this same file back into the chat UI,
    // silently truncate what a user can scroll back to as well). Letting it
    // throw means this conversation is skipped for this sweep and retried
